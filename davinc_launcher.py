...
gif_vie = []
gif_vie.append(Animation("data\\gif_vie\\tmp-",0, 0))
...
conso = 'Souffre'
rejet = 'Dihydrogene'
nom_fin = font.render(nom_vie,1,(255,255,255))
...
def tuto():
  global chrono_stop
  image_tuto = pygame.image.load('data\\jpg\\tutoriel.jpg').convert_alpha()
  tuto_balise = True
  chrono_stop = True
  a = 0
  i = 0
...
def creer_vie():
  ...
  selectBouton = 0
  i = 0
  atome_type = ['Dioxygene', 'CO2', 'Souffre', 'Dihydrogene']
...
def jouer():
  ...
  global menu_vie,vie_lock, epoque, lock_pop ######################################################################################## GLOBAL EPOQUE
...
def skill_tree_a():
    global points, nb_skill, alerte_not_point, last_skill, dev_alea, suite
    ...
    gameDisplay.blit((font3.render("Points: " + str(points),1,(100,100,100))),(530,665))
